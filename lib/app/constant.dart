...
import 'package:flutter_music/app/setting/impl/setting_model.dart';
import 'package:flutter_music/generated/l10n.dart';
import 'package:remixicon/remixicon.dart';

class Constant{
  static Map<String,NavIconItem> navItems(BuildContext context)=> {
    "search": NavIconItem(iconData: CupertinoIcons.search, title: S.of(context).nav_search, index: 0),
  ...
  static List<SettingThemeItem> settingThemeItems(BuildContext context)=>[
    SettingThemeItem(fluent.Colors.green, S.of(context).theme_green),
    SettingThemeItem(fluent.Colors.magenta, S.of(context).theme_mid_autumn),
    SettingThemeItem(fluent.Colors.yellow, S.of(context).theme_happy_new_year),
    SettingThemeItem(fluent.Colors.blue, S.of(context).theme_blue),
    SettingThemeItem(fluent.Colors.orange, S.of(context).theme_orange),
    SettingThemeItem(fluent.Colors.teal, S.of(context).theme_brown),
    SettingThemeItem(fluent.Colors.purple, S.of(context).theme_purple),
    SettingThemeItem(fluent.Colors.red, S.of(context).theme_red),
  ];
